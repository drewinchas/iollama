...
def init_index(embed_model, input_files):
...
def init_query_engine(index):
    ...
    template = (
        "Imagine you are a privacy expert in privacy laws, with access to all current and relevant legal documents, "
        "case studies, and expert analyses. Your goal is to provide insightful, accurate, and concise answers to questions about the privacy policy which you have been provided.\n\n"
        ...
        "Question: {query_str}\n\n"
        "Answer succinctly, providing numerical percentage of policy completeness, list of the policy's strengths, list of the policy's weaknesses, and a list of recommendations to improve the policy."
    )
